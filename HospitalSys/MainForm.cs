...
using HospitalSys.Appointments;
using HospitalSys.Doctors;
using HospitalSys.Invoices;
using HospitalSys.LabTests;
using HospitalSys.Loging;
using HospitalSys.Managers;
using HospitalSys.Medicals;
using HospitalSys.Nurses;
using HospitalSys.OtherEmployee;
using HospitalSys.PateintsRecords;
using HospitalSys.Patients;
using HospitalSys.Payments;
using HospitalSys.Rooms;
using HospitalSys.SurgeryProcedures;
...
namespace HospitalSys
{
    public partial class MainForm : Form
    {
        ...
        private void dischargPatientToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            ListOfInvoices frm = new ListOfInvoices();
            frm.ShowDialog();
        }
        ...
        {
            ListOfAllPaymentTransactons frm = new ListOfAllPaymentTransactons();
            frm.ShowDialog();
        ...
        {
            ListOfHSRooms frm = new ListOfHSRooms();
            frm.ShowDialog();
        }
        ...
        private void wareHouseRoomsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ListOfWareHouseRooms frm = new ListOfWareHouseRooms();
            frm.ShowDialog();
        }

        private void mangersListToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ManagersList frm = new ManagersList();
            frm.ShowDialog();
        }

        private void addNewManagerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            AddNewManager frm = new AddNewManager();
            frm.ShowDialog();
        }
        ...
        private void FindNurseStripButton5_Click(object sender, EventArgs e)
        {
            FindNurse frm = new FindNurse();
            frm.ShowDialog();
        }

        private void PayInvoiceStripButton6_Click(object sender, EventArgs e)
        {
            AddNewPayment frm = new AddNewPayment();
            frm.ShowDialog();
        }

        private void CheckDoctorStripButton8_Click(object sender, EventArgs e)
        {
            FindDoctor frm = new FindDoctor();
            frm.ShowDialog();
        }

        private void BuyMedicalStripButton9_Click(object sender, EventArgs e)
        {
            AddNewMedicalQuantityInStorage frm = new AddNewMedicalQuantityInStorage();
            frm.ShowDialog();
        }
